...
##word_count_label = tk.Label(root, textvariable=word_count, font=("Helvetica", 14))
##word_count_label.grid(row=0, column=1, sticky="nw", padx=10)

# Variable to hold the list of words
##word_list = tk.StringVar()
##word_list.set("Words used: ")

# Label to display the list of words
##word_list_label = tk.Label(root, textvariable=word_list, font=("Helvetica", 12), wraplength=300, justify="left")
##word_list_label.grid(row=1, column=1, sticky="nw", padx=10)

# Variable to hold the count of capitalized words
##capitalized_word_count = tk.StringVar()
##capitalized_word_count.set("Capitalized Words: 0")

# Label to display the count of capitalized words
##capitalized_word_count_label = tk.Label(root, textvariable=capitalized_word_count, font=("Helvetica", 14))
##capitalized_word_count_label.grid(row=2, column=1, sticky="nw", padx=10)
